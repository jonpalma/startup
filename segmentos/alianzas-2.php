...
<html lang="es">
  <head>
    <?php 
        ...
        $sql = "SELECT pregunta2 FROM alianzas WHERE id_alianzas=" . $id_alianzas;
  ...
  <body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <form action="set_aliance2.php" method="post">
                    <div class="cont-center">
                        <h3>¿Quiénes son nuestros proveedores clave?   </h3>
                        <textarea type="text" name="respuesta" class="input-answer" ><?php echo $respuesta; ?></textarea>
                        <p>Ejemplo: Productores de fruta orgánica, proveedores de envases de vidrio y de sustituto de azúcar.</p>
