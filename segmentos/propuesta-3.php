...
<html lang="es">
  <head>
    <?php 
        ...
        $sql = "SELECT pregunta3 FROM propuesta_valor WHERE id_propuesta_valor=" . $id_propuesta_valor;
  ...
  <body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <form action="set_prop3.php" method="post">
                    <div class="cont-center">
                        <h3>¿Qué servicios o productos estas ofreciendo a los clientes?  </h3>
                        <textarea type="text" name="respuesta" class="input-answer" ><?php echo $respuesta; ?></textarea>
                        <p>Ejemplo: Mermelada en envase de 500grs con decoración artesanal. </p>
