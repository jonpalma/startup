...
<html lang="es">
  <head>
    <?php 
        ...
        $sql = "SELECT pregunta4 FROM canales_dist WHERE id_canales_dist=" . $id_canales_dist;
  ...
  <body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <form action="set_channel4.php" method="post">
                    <div class="cont-center">
                        <h3>¿Cómo se establece comunicación con los clientes?</h3>
                        <textarea type="text" name="respuesta" class="input-answer" ><?php echo $respuesta; ?></textarea>
                        <p>Ejemplo: Telefonía y medios de promoción tradicionales porque el perfil del cliente es ver televisión, escuchar la radio, lectura de periódico entre otras. </p>
